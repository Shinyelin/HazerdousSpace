...
/*
        ...
        updateBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EditText edit_temp = findViewById(R.id.edit_bzr);
                ...
                try {
                    ...
                    String bzr_input = edit_temp.getText().toString();
                    if (bzr_input != null && !bzr_input.equals("")) {
                        JSONObject tag1 = new JSONObject();
                        tag1.put("tagName", "Buzzer");
                        tag1.put("tagValue", bzr_input);
    ...
    private void clearTextView() {
        ...
        TextView reported_tempTV = findViewById(R.id.reported_bzr);
        reported_tempTV.setText("");
        reported_ledTV.setText("");

        TextView desired_ledTV = findViewById(R.id.desired_led);
        TextView desired_tempTV = findViewById(R.id.desired_bzr);
