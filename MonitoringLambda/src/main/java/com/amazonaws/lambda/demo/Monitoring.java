...
public class Monitoring implements RequestHandler<Object, String> {
	...
	public String handleRequest(Object input, Context context) {
	    ...
	    final String AccessKey="AKIAW7UG6YYDENPODOQG";
	    final String SecretKey="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";
	    final String topicArn="arn:aws:sns:ap-northeast-2:480245630470:MyTopic";
	    ...
	    final String msg = "*Distance Critical*\n" + "Distance is " + dist + "cm";
